...
#Region "Color of Control"
    Protected Overrides Sub PaintHook()
        ...
        If _ShowIcon = False Then
            ...
            G.DrawString(Text, Font, New SolidBrush(Color.FromArgb(71, 225, 12)), New Point(8, 8))
        Else
            ...
            G.DrawString(Text, Font, New SolidBrush(Color.FromArgb(71, 225, 12)), New Point(28, 8))
        End If
...
#Region "Color Of Control"
    Protected Overrides Sub PaintHook()
        ...
        G.DrawString(Text, Font, New SolidBrush(Color.FromArgb(71, 225, 12)), New Point(1, 1))
    End Sub
#End Region
End Class
...
#Region "Color Of Control"
    Protected Overrides Sub PaintHook()
        ...
        G.DrawString(Text, Font, New SolidBrush(Color.FromArgb(71, 225, 12)), New Rectangle(0, 0, Width - 1, Height - 1), New StringFormat() With {.Alignment = StringAlignment.Center, .LineAlignment = StringAlignment.Center})
...
#Region "Color of Control"
    Protected Overrides Sub OnDrawItem(ByVal e As DrawItemEventArgs)
        ...
        Try
            ...
            G.DrawString(" " & Items(e.Index).ToString(), Font, New SolidBrush(Color.FromArgb(71, 225, 12)), e.Bounds.X, e.Bounds.Y + 1)
        Catch : End Try
...
#Region "Color of Control"
    Protected Overrides Sub PaintHook()
        ...
        'G.DrawString(Text, Font, New SolidBrush(Color.FromArgb(71, 225, 12)), New Point(8, 6))

        DrawText(New SolidBrush(Color.Black), HorizontalAlignment.Center, 1, 1)
        DrawText(New SolidBrush(Color.FromArgb(71, 225, 12)), HorizontalAlignment.Center, 2, 2)
...
#Region "Color of Control"
    Protected Overrides Sub PaintHook()
        ...
        If _Checked Then
            ...
            G.DrawString("a", New Font("Marlett", 12), New SolidBrush(Color.FromArgb(71, 225, 12)), New Point(-2, 0))
        Else
            ' Do Nothing ^^
        End If
        ...
        G.DrawString(Text, Font, New SolidBrush(Color.FromArgb(71, 225, 12)), 18, 1)
    End Sub
...
#Region "Color Of Control"
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        If Not SelectedIndex = -1 Then
            ...
            G.DrawString(TabPages(SelectedIndex).Text, Font, New SolidBrush(Color.FromArgb(71, 225, 12)), x1, New StringFormat With {.LineAlignment = StringAlignment.Center, .Alignment = StringAlignment.Center})
        End If
...
#Region "Color Of Control"
    Protected Overrides Sub PaintHook()
        ...
        If _Checked Then
            G.FillEllipse(New SolidBrush(Color.FromArgb(71, 225, 12)), 5, 5, 6, 6)
        Else
        End If
...
#Region "Color Of Control"
    Protected Overrides Sub PaintHook()
        ...
        If _StateMinimize = True Then
            G.DrawString("0", New Font("Marlett", 8), New SolidBrush(Color.FromArgb(71, 225, 12)), New Point(6, 4))
            _StateClose = False ' false
            _StateMaximize = False
        End If
        If _StateClose = True Then
            G.DrawString("r", New Font("Marlett", 8), New SolidBrush(Color.FromArgb(71, 225, 12)), New Point(6, 4))
            _StateMinimize = False
            _StateMaximize = False
        End If

        If _StateMaximize = True Then
            If FindForm.WindowState <> FormWindowState.Maximized Then G.DrawString("1", New Font("Marlett", 8), New SolidBrush(Color.FromArgb(71, 225, 12)), New Point(6, 4)) Else G.DrawString("2", New Font("Marlett", 8), New SolidBrush(Color.FromArgb(71, 225, 12)), New Point(6, 4))
            _StateClose = False ' false
            _StateMinimize = False
        End If
...
#Region "Properties"
    ...
    Sub New()
        ...
        Base.ForeColor = Color.FromArgb(71, 225, 12)
        If _Multiline Then
            Base.Height = Height - 11
        Else
            LockHeight = Base.Height + 11
        ...
        Using B As New Bitmap(Width, Height)
            ...
            Using G = Graphics.FromImage(B)
                ...
                If _ShowPercentage Then
                    ...
                    G.DrawString(Convert.ToString(String.Concat(Progress, "%")), Font, New SolidBrush(Color.FromArgb(71, 225, 12)), New Rectangle(0, 1, Width - 1, Height - 1), New StringFormat() With {.Alignment = StringAlignment.Center, .LineAlignment = StringAlignment.Center})
                End If
